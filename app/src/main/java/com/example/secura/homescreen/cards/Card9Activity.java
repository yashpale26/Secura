...
public class Card9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button startScanButton = findViewById(R.id.btn_start_scan9);
        startScanButton.setOnClickListener(v -> {
            // TODO: Replace PlaceholderActivity.class with the actual class for the next activity.
            Intent intent = new Intent(Card9Activity.this, AppManagementActivity.class);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Card9Activity.this, HomeActivity.class);
                startActivity(intent);
