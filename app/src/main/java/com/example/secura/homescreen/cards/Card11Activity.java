...
public class Card11Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button startScanButton = findViewById(R.id.btn_start_scan11);
        startScanButton.setOnClickListener(v -> {
            // TODO: Replace PlaceholderActivity.class with the actual class for the next activity.
            Intent intent = new Intent(Card11Activity.this, SecureBrowserActivity.class);
            startActivity(intent);
        });

        // Find the back button and set its click listener
        Button backButton = findViewById(R.id.btn_back11);
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Navigate back to the home screen
                Intent intent = new Intent(Card11Activity.this, HomeActivity.class);
                startActivity(intent);
